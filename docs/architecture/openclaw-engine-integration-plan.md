...
```bash
***REDACTED_RUBYGEMS_KEY***|optional|off
```
...
***REDACTED_RUBYGEMS_KEY***
***REDACTED_RUBYGEMS_KEY***  # later: summary,llm_quality,rank
***REDACTED_RUBYGEMS_KEY*** # true for manual interactive runs if desired
```
