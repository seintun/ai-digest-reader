...
def ***REDACTED_RUBYGEMS_KEY***(monkeypatch):
    ...
    monkeypatch.setenv("***REDACTED_RUBYGEMS_KEY***", "3")
    monkeypatch.setenv("***REDACTED_RUBYGEMS_KEY***", "1.0")
...
def ***REDACTED_RUBYGEMS_KEY***(monkeypatch):
    monkeypatch.setenv("OPENROUTER_API_KEY", "test-key")
    monkeypatch.setenv("***REDACTED_RUBYGEMS_KEY***", "4")
    monkeypatch.setenv("***REDACTED_RUBYGEMS_KEY***", "0.0000001")
